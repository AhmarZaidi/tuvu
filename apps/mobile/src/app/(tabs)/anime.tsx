...
export default function AnimeScreen() {
  const {
    ...
    queryFn: () => api.getDashboard('anime'),
  });
    ...
    return (
      <View style={styles.centerContainer}>
        <View style={styles.errorBox}>
          <Text style={styles.errorTitle}>Could not load anime</Text>
    ...
    >
      {sections.length === 0 ? (
        <View style={styles.emptyState}>
          <Text style={styles.emptyTitle}>No anime tracked yet</Text>
          <Text style={styles.emptySubtitle}>
            Add anime series or movies to your library from Explore.
          </Text>
        </View>
      ) : (
