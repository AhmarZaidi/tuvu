/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 66cde9335adf2396c16a7d898b0e5dbb)
...
interface __BaseEnv_Env {
	...
	SUPABASE_STORAGE_AVATARS_BUCKET: string;
	SUPABASE_STORAGE_MEDIA_CACHE_BUCKET: string;
	tuvu?: D1Database;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_APP_URL" | "APP_NAME" | "TMDB_API_KEY" | "RAWG_API_KEY" | "OPEN_LIBRARY_CONTACT_EMAIL" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "SUPABASE_STORAGE_AVATARS_BUCKET" | "SUPABASE_STORAGE_MEDIA_CACHE_BUCKET">> {}
}
