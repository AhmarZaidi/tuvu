/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b70a565f382bf8cb848040004254c370)
// Runtime types generated with workerd@1.20260708.1 2026-07-09 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	ENVIRONMENT: "staging" | "production" | "development";
	SUPABASE_STORAGE_AVATARS_BUCKET: "tuvu-avatars-staging" | "tuvu-avatars";
	SUPABASE_STORAGE_MEDIA_CACHE_BUCKET: "tuvu-media-cache-staging" | "tuvu-media-cache";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		ENVIRONMENT: "staging";
		SUPABASE_STORAGE_AVATARS_BUCKET: "tuvu-avatars-staging";
		SUPABASE_STORAGE_MEDIA_CACHE_BUCKET: "tuvu-media-cache-staging";
		PUBLIC_APP_URL: string;
		APP_NAME: string;
		TMDB_API_KEY: string;
		RAWG_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SUPABASE_STORAGE_AVATARS_BUCKET" | "SUPABASE_STORAGE_MEDIA_CACHE_BUCKET" | "PUBLIC_APP_URL" | "APP_NAME" | "TMDB_API_KEY" | "RAWG_API_KEY" | "OPEN_LIBRARY_CONTACT_EMAIL">> {}
}
